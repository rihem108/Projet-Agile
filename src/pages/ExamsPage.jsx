...
const ExamsPage = () => {
  ...
  const [localExams, setLocalExams] = useState([
    { id: 1, subject: 'Mathématiques', code: 'MATH201', date: '2026-05-15', time: '09:00', duration: '2h', room: 'Amphithéâtre A', supervisor: 'Dr. Mohamed Ben Ali', coefficient: 3, maxScore: 100, type: 'normal', status: 'scheduled', registeredStudents: 45, completedStudents: 0, avgScore: null },
    { id: 2, subject: 'Physique', code: 'PHY301', date: '2026-05-16', time: '14:00', duration: '1h30', room: 'Laboratoire B', supervisor: 'Pr. Sarah Williams', coefficient: 2, maxScore: 100, type: 'normal', status: 'scheduled', registeredStudents: 32, completedStudents: 0, avgScore: null },
    { id: 3, subject: 'Informatique', code: 'INF101', date: '2026-05-18', time: '10:00', duration: '3h', room: 'Salle A101', supervisor: 'M. Karim Ben Ali', coefficient: 4, maxScore: 100, type: 'practical', status: 'scheduled', registeredStudents: 28, completedStudents: 0, avgScore: null },
    { id: 4, subject: 'Anglais', code: 'ANG202', date: '2026-05-20', time: '08:30', duration: '1h', room: 'Salle B202', supervisor: 'Mme. Sophie Martin', coefficient: 1, maxScore: 100, type: 'normal', status: 'scheduled', registeredStudents: 38, completedStudents: 0, avgScore: null },
    { id: 5, subject: 'Algorithmique', code: 'ALG102', date: '2026-05-22', time: '13:00', duration: '2h30', room: 'Salle C303', supervisor: 'Dr. Ahmed Mansouri', coefficient: 5, maxScore: 100, type: 'practical', status: 'scheduled', registeredStudents: 25, completedStudents: 0, avgScore: null },
  ]);
