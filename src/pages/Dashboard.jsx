...
const Dashboard = () => {
  const { users, exams, rooms, grades } = useContext(AppContext);
  ...
  return (
    <div>
      ...
      <div className="glass-card">
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Bienvenue sur le module d'administration. Utilisez la barre latérale pour naviguer et gérer l'organisation des examens.</p>
      </div>
    </div>
  );
};
